...
public class men8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        productPriceWomen = (TextView) findViewById(R.id.product_priceMen8);
        productDesc = (TextView) findViewById(R.id.product_descMen8);
        imageWomen = (ImageView) findViewById(R.id.productImageMen8);
    ...
    private void addingToCartList() {
        ...
        mReference.child(mAuth.getCurrentUser().getDisplayName()).child("Men8").setValue(cartMap);
